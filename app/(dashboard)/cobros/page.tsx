...
export default function CobrosPage() {
  ...
  const load = useCallback(async () => {
    ...
    let q = supabase
      .from('recibos_cobro')
      .select('*, clientes(nombre_razon_social)', { count: 'exact' })
