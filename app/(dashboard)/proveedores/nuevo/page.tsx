...
export default function NuevoProveedorPage() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto"><ContactoForm initialData={{ condicion_iva: 'RI', tipo_factura: 'A' }} onSubmit={handleSubmit} submitLabel="Guardar proveedor" /></div>
    </div>
  )
}
